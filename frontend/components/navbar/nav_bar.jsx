      ...
      <header className="header">
        <nav className="header-nav">
          ...
          <ul className="header-list">
              ...
              <div className="nav-bar-item">
                <span class="nav_item_icon">
                  <svg width="25px" height="25px" viewBox="0 0 50 50" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g id="Icons" stroke="none" stroke-width="1" fill="var(--icon_color, #555)" fill-rule="evenodd">
            ...
            <li>
              <div className="nav-bar-item">
                <span class="nav_item_icon"><svg width="25px" height="25px" viewBox="0 0 50 50" version="1.1" xmlns="http://www.w3.org/2000/svg">
                  <g id="answer" stroke="none" stroke-width="1" fill="var(--icon_color, #555)" fill-rule="evenodd">
